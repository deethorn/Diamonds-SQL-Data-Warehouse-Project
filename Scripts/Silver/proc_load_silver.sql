...
Purpose:
    This stored procedure executes an ETL (Extract, Transform, Load) process
    to transfer data from the 'bronze' schema into the 'silver' schema.
Operations Performed:
    - Clears Silver tables using TRUNCATE.
    - Loads cleaned and transformed data from Bronze into Silver tables.

Parameters:
    None.
    This procedure does not accept parameters or return any output.
